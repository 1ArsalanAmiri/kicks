...
TEST_PRODUCTS = [
...

  {
    ...
    "descriptionOptions": ["Shown: Hyper Grape/Brilliant Orange/Court Purple/Metallic Gold", "Style: IH7399-500"],
    "categories": ["Basketball", "Lifestyle"],
    "genders": ["Men"],
    "colors": ["#000000", "#4169E1", "#556B2F", "#800020"],
    "price": 115,
    ...
    def handle(self, *args, **kwargs):
        for prod_data in TEST_PRODUCTS:
            ...
            for size_data in prod_data.get("sizes", []):
              size_obj, _ = ProductSize.objects.get_or_create(value=size_data["value"],defaults={"active": size_data.get("active", True)})
            ...
            product, created = Product.objects.get_or_create(
                ...
                defaults={
                    "description_text": prod_data["descriptionText"],
                    "description_options": prod_data["descriptionOptions"],
                    "genders": prod_data["genders"],
                    "price": prod_data["price"],
                    "colors": prod_data["colors"],
                    "is_new_release": prod_data["isNewRelease"],
            ...
            if "categories" in prod_data:
              ...
              product.categories.set(cat_objs)

            # Images
            image_objs = []
            for idx, filename in enumerate(prod_data.get("images", []), start=1):
